 ...
 */
public class Tuple009<T001, T002, T003, T004, T005, T006, T007, T008, T009>
	extends ATuple<Tuple008<T001, T002, T003, T004, T005, T006, T007, T008>, T009> {
	//// =======================================================================
	 ...
	 */
	private static Tuple009<?, ?, ?, ?, ?, ?, ?, ?, ?> nullTuple = null;
	////
	 ...
	 */
	public Tuple009(final T001 v001, final T002 v002, final T003 v003, final T004 v004, final T005 v005, final T006 v006, final T007 v007, final T008 v008, final T009 v009) {
		this(new Tuple008<T001, T002, T003, T004, T005, T006, T007, T008>(v001, v002, v003, v004, v005, v006, v007, v008), v009);
	}

	/** Constructor initializing all the elements of the tuple 
	 * with values as given by the passed parameters.
	 * @param tupleMinusOne The tuple minus one from which to 
	 * initialize the first 8 element values.
	 * @param v009 The value of the 9. element.
	 */
	protected Tuple009(Tuple008<T001, T002, T003, T004, T005, T006, T007, T008> tupleMinusOne, final T009 v009) {
		super(checkTupleNotNull(tupleMinusOne), v009);
	}
	////
	//// END Constructors
	//// =======================================================================
	...
	public static <T001, T002, T003, T004, T005, T006, T007, T008, T009> Tuple009<T001, T002, T003, T004, T005, T006, T007, T008, T009> nullTuple() {
		if (Tuple009.nullTuple == null) {
			Tuple009.nullTuple =
					new Tuple009<Object, Object, Object, Object, Object
					           , Object, Object, Object, Object>(
					            		 (Object)null, (Object)null, (Object)null, (Object)null, (Object)null
					            	, (Object)null, (Object)null, (Object)null, (Object)null);
		}

		return (Tuple009<T001, T002, T003, T004, T005, T006, T007, T008, T009>)nullTuple;
	}
