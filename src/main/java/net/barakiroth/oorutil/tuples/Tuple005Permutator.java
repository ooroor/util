 ...
 */
public class Tuple005Permutator<T001, T002, T003, T004, T005>
extends ATuplePermutator<Tuple004Permutator<T001, T002, T003, T004>, T005, Tuple004<T001, T002, T003, T004>, Tuple005<T001, T002, T003, T004, T005>> {
	//// =======================================================================
	 ...
	 */
	public Tuple005Permutator(final T001[] v001s, final T002[] v002s, final T003[] v003s, final T004[] v004s, final T005[] v005s) {
		this(v001s, v002s, v003s, v004s, v005s, null);
	}
	 ...
	 */
	public Tuple005Permutator(final T001[] v001s, final T002[] v002s, final T003[] v003s, final T004[] v004s, final T005[] v005s, final Random random) {
		super(new Tuple004Permutator<T001, T002, T003, T004>(v001s, v002s, v003s, v004s, random), checkEmpty(checkNull(v005s)), random);
	}
	////
	//// END Constructors
	//// =======================================================================
	...
	////
	@Override
	protected Tuple005<T001, T002, T003, T004, T005> createTuple(final Tuple004<T001, T002, T003, T004> tupleNMinusOne, final T005 v005) {

		final Tuple005<T001, T002, T003, T004, T005> tuple =
				new Tuple005<T001, T002, T003, T004, T005>(tupleNMinusOne, v005);
