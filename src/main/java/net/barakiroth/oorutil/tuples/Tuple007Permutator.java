 ...
 */
public class Tuple007Permutator<T001, T002, T003, T004, T005, T006, T007>
extends ATuplePermutator<Tuple006Permutator<T001, T002, T003, T004, T005, T006>, T007, Tuple006<T001, T002, T003, T004, T005, T006>, Tuple007<T001, T002, T003, T004, T005, T006, T007>> {
	//// =======================================================================
	 ...
	 */
	public Tuple007Permutator(final T001[] v001s, final T002[] v002s, final T003[] v003s, final T004[] v004s, final T005[] v005s, final T006[] v006s, final T007[] v007s) {
		this(v001s, v002s, v003s, v004s, v005s, v006s, v007s, null);
	}
	 ...
	 */
	public Tuple007Permutator(final T001[] v001s, final T002[] v002s, final T003[] v003s, final T004[] v004s, final T005[] v005s, final T006[] v006s, final T007[] v007s, final Random random) {
		super(new Tuple006Permutator<T001, T002, T003, T004, T005, T006>(v001s, v002s, v003s, v004s, v005s, v006s, random), checkEmpty(checkNull(v007s)), random);
	}
	////
	//// END Constructors
	//// =======================================================================
	...
	////
	@Override
	protected Tuple007<T001, T002, T003, T004, T005, T006, T007> createTuple(final Tuple006<T001, T002, T003, T004, T005, T006> tupleNMinusOne, final T007 v007) {

		final Tuple007<T001, T002, T003, T004, T005, T006, T007> tuple =
				new Tuple007<T001, T002, T003, T004, T005, T006, T007>(tupleNMinusOne, v007);
